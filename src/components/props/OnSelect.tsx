  ...
  return (
    <div className="pb-8 mb-6">
      ...
      <p className="m-0 mt-2">
        ...
        <HighLight to>beforeSelect</HighLight> function and allows you to set the
        selected value to the state or execute custom logic before finalizing
        the selection.
      </p>
        ...
        subtitleElement={{
          element: (
            <p className="m-0 mt-4">
              A basic example of the <HighLight>onSelect</HighLight>{" "}
              callback function that updates the state with the selected value.
            </p>
          ),
        }}
